...
BOT_TOKEN = "MTIyMzI2Nzc5OTg4ODAzOTk1Ng.GPvJr_.wEbjVq9RJC8GbBDPB_MMFUkjmeTVtgfvexmeLA"

# Predefined list of allowed HWIDs
ALLOWED_HWIDS = ["1C3FC954-B0dB-EC11-80E5-088FC3674019", "A445BE53-EE82-723C-FB80-04D9F5CB2E81"]  # Add allowed HWIDs here

def get_hwid():
    try:
        # Command to get the HWID (example for Windows, change if needed for other OS)
...
async def main():
    hwid = get_hwid()
    if hwid and verify_hwid(hwid):
        await client.start(BOT_TOKEN)
    else:
        print("HWID verification failed. Exiting...")
        sys.exit()
